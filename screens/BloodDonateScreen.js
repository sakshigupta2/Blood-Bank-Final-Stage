    ...
    snapshot.forEach((doc)=>{
      if(doc.data().blood_status !== "donated"){
        this.setState({
          ...
          bloodStatus:doc.data().book_status,
          docId     : doc.id
        })
      }
    })
    ...
    if(this.state.IsBookRequestActive === true){
      return(
        ...
        <View style = {{flex:1,justifyContent:'center'}}>
          ...
          <Text style = {{fontSize: RFValue(20)}}>Blood Group</Text>
          <Text>{this.state.requestedBloodName}</Text>
          </View>
          <View style={{borderColor:"#ff8085",borderWidth:5,justifyContent:'center',alignItems:'center',padding:10,margin:10}}>
          <Text style = {{fontSize: RFValue(20)}}> Blood Status </Text>
          ...
          <Text style = {{color: "#9e0000", fontSize: RFValue(20), fontWeight: 'bold'}}>I donated the blood </Text>
          </TouchableOpacity>
        </View>
      )
    }
        ...
        <View style={{flex:1}}>
          ...
          <ScrollView>
            <KeyboardAvoidingView style={styles.keyBoardStyle}>
              ...
              />
              <Text style = {{marginTop: 50, textAlign: 'center', fontSize: RFValue(20), color: '#9e0000', fontWeight: 'bold'}}> 
              * Note * - If the donor is dealing with any medical or health problem his donation may be rejected.
              ...
              <TouchableOpacity
                ...
                >
                <Text  style={{color:'#ffc0cb', fontWeight: 'bold', fontSize: RFValue(20)}}>Donate Blood</Text>
              </TouchableOpacity>
